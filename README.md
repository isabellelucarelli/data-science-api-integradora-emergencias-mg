...
[![FastAPI](https://img.shields.io/badge/FastAPI-Production_Ready-009688)](https://fastapi.tiangolo.com/)
...
Este módulo específico funciona como o "cérebro" do ecossistema, sendo a **Single Source of Truth (SSOT)** para logística de abrigos, pontos de coleta e prevenção de fraudes.

## 🏗️ Pilares de Atuação (Data Science)
Como responsável pela área de dados neste módulo, meu trabalho foca em quatro pilares:

* **Data Wrangling & Geoprocessamento:** Tratamento de dados heterogêneos e enriquecimento de datasets via geocodificação para viabilizar análises espaciais e mapeamento de risco em alta precisão.
...
* **Liderança Estratégica e Orientação Técnica:** [Ricardo da Rocha] (LINK_DO_GITHUB)
...
- [Ricardo da Rocha] (LINK_DO_GITHUB)
- [Carlos Alexandre](https://github.com/carlosalexandre94)
- [Isabelle Lucarelli](https://github.com/isabellelucarelli)
- [Ana Luiza Bicalho] (LINK_DO_GITHUB)
- [Pedro H. Diniz] (LINK_DO_GITHUB)
-  [Izabela Ribas] (LINK_DO_GITHUB)
- [Renato Lobo] (LINK_DO_GITHUB)
- [Eduardo Batista] (LINK_DO_GITHUB)
